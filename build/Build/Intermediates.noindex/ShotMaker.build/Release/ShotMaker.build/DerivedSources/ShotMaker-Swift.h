...
#ifndef SHOTMAKER_SWIFT_H
#define SHOTMAKER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ShotMaker",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9ShotMaker17StatusBarDelegate")
...
@class NSMenu;
@interface StatusBarDelegate (SWIFT_EXTENSION(ShotMaker)) <NSMenuDelegate>
